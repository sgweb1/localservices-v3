...
export const DevToolsPanel: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Panel */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-96 glass-card rounded-2xl shadow-2xl animate-slide-up overflow-hidden">
          {/* Header */}
          ...
          <div className="p-4">
            {activeTab === 'settings' && (
              <div className="space-y-3">{/* Mock Mode Toggle */}
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-yellow-50 rounded-xl border border-yellow-200">
                  <p className="text-xs text-yellow-800">
                    <strong>⚠️ Uwaga:</strong> Funkcja dostępna tylko w trybie DEV. 
                    Dodaje prawdziwe dane do bazy lokalnej.
                  </p>
                </div>
              </div>
            )}
