...
export const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 shadow-sm', className)}
    {...props}
  />
));
...
export const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(({ className, ...props }, ref) => (
  <h3 ref={ref} className={cn('text-base font-normal leading-tight tracking-tight text-gray-900 dark:text-white', className)} {...props} />
));
CardTitle.displayName = 'CardTitle';

export const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn('text-xs text-gray-600 dark:text-gray-400', className)} {...props} />
));
...
export const StatCard: React.FC<{
  ...
  return (
    <div
      className={cn(
        'bg-gradient-to-br rounded-lg shadow-sm border p-3 transition-all duration-200',
    ...
    >
      <div className="flex items-start justify-between">
        <div className="space-y-0.5">
          ...
          <div className="text-base font-normal text-slate-900">{value}</div>
          {trend && (
        ...
        {icon && (
          <div className="p-1.5 bg-white/30 rounded-md">
            {icon}
          </div>
        )}
      </div>
